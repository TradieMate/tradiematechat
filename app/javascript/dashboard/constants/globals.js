export default {
  ...
  DOCS_URL: 'https://www.tradiemate.ai/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.tradiemate.ai/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.tradiemate.ai/content.json',
