...
# Render expects the app to bind to $PORT which defaults to 10000
EXPOSE ${PORT:-10000}

# Start the server, binding to 0.0.0.0 and using the PORT env variable from Render
CMD ["sh", "-c", "bundle exec rails server -b 0.0.0.0 -p ${PORT:-10000}"]